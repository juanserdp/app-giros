...
export function FormEnviarGiros({
  ...
  return (
    ...
    >
      <Row className="mb-3">
        <h3 className="mb-3 p-3 rounded" style={textStyleH2}>
          Datos personales
        </h3>
        <Form.Group as={Col} md="4" controlId="validationNombres">
          <Form.Label style={{ color: "white" }}>Nombres</Form.Label>
          <Form.Control
            required
            type="text"
      ...
      <Row className="mb-3">
        <Form.Group as={Col} md="4" controlId="validationTipoDocumento">
          <Form.Label style={{ color: "white" }}>Tipo de Documento</Form.Label>
          <Form.Select
            required
      ...
      <Row className="mb-3">
        ...
        <Form.Group as={Col} md="4" controlId="validationEstado">
          <Form.Label style={{ color: "white" }}>Tipo de Cuenta</Form.Label>
          <Form.Select
            required
            disabled={false}
        ...
        <Form.Group as={Col} md="4" controlId="validationSaldo">
          <Form.Label style={{ color: "white" }}>Numero de Cuenta</Form.Label>
          <Form.Control
            required
            type="number"
      ...
      <Row className="mb-3">
        <Form.Group as={Col} md="4" controlId="validationEstado">
          <Form.Label style={{ color: "white" }}>Banco</Form.Label>
          <Form.Select
            required
            disabled={false}
      ...
      <Row className="mb-3">
        ...
        <Form.Group as={Col} md="4" controlId="validationSaldo">
          <Form.Label style={{ color: "white" }}>Valor</Form.Label>
          <Form.Control
            required
            type="text"
            ...
            value={
              form.valorGiro
                ? currencyFormatter.format(
                    (form.valorGiro * 1) / usuario.usuario.tasaVenta
                  )
                : ""
            }
            disabled={true}
