...
export function NumeroDocumentoRemitente({ value, onChange, md, disabled }) {
    return <Form.Group style={{ fontFamily: "'Roboto', sans-serif" }} as={Col} className="mb-3" controlId="label_numeroDocumento" md={md}>
        ...
        <Form.Control
            required
            maxLength="20"
            name="numeroDocumentoRemitente"
            onChange={event => onChange(event, "numeroDocumentoRemitente")}
            value={value}
            type="text"
